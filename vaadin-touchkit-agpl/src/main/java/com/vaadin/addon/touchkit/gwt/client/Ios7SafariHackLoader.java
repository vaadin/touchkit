    ...
    private static final class ViewportHeightHack implements RepeatingCommand,
        ...
        /*-{
            ...
            $wnd.addEventListener('orientationchange', function () {
                that.@com.vaadin.addon.touchkit.gwt.client.Ios7SafariHackLoader.ViewportHeightHack::onOrientationChange()();
            });
            $doc.addEventListener('focusin', function () {
                that.@com.vaadin.addon.touchkit.gwt.client.Ios7SafariHackLoader.ViewportHeightHack::onFocusIn()();
            });
            $doc.addEventListener('focusout', function () {
                that.@com.vaadin.addon.touchkit.gwt.client.Ios7SafariHackLoader.ViewportHeightHack::onFocusOut()();
            });
        }-*/;
