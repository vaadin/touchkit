...
public class FieldsTest extends AbstractTouchKitIntegrationTest implements ClickListener {
	...
	public void buttonClick(ClickEvent event) {
		if(switchComponent.getValue()) {
			...
			Notification.show(textField.getValue(),textArea.getValue(), getType());
		}
