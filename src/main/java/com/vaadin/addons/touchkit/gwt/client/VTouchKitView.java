...
public class VTouchKitView extends VView {
	...
	/*-{
		...
		var success = function(loc) {
			me.@com.vaadin.addons.touchkit.gwt.client.VTouchKitView::onGeolocationSuccess(Lcom/vaadin/addons/touchkit/gwt/client/Position;)(loc);
		}
		var error = function(e) {
			me.@com.vaadin.addons.touchkit.gwt.client.VTouchKitView::onGeolocationError(I)(e.code);
		}
	...
	private void onGeolocationError(int errorCode) {
		...
		client.updateVariable(client.getPid(this), "positionError", errorCode, true);
	}
